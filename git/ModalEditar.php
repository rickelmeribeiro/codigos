        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="NOMEDOFORMULARIOEDITAR" id="NOMEDOFORMULARIOEDITAR" method="post" action="#">
                            <div class="mb-3">
                                <input type="hidden" name="NOMEDOIDREGSATADO" id="NOMEDOIDREGSATADO">
                            ...
                            <div class="mb-3">
                                <label for="NOMEDOINPUT2" class="form-label">NOMEDOINPUT2:</label>
                                <input type="text" name="NOMEDOINPUT2" class="form-control" id="NOMEDOINPUT2">
                            </div>
                            <button type="submit" id="BOTAOEDIT" class="btn btn-primary">Cadastrar</button>
